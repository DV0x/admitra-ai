...
export function ChatInput({
  ...
  onRemoveImage,
  isGenerating,
  placeholder = "Describe your ad campaign... (e.g., 'Diwali jewelry ad in Telugu')",
}: ChatInputProps) {
      ...
      <form onSubmit={handleSubmit} className="flex items-end gap-2 max-w-2xl mx-auto">
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            className="w-full px-4 py-2.5 bg-surface border border-border rounded-2xl text-text-primary placeholder:text-text-muted resize-none focus:outline-none focus:border-accent/50 focus:ring-1 focus:ring-accent/20 transition-all disabled:opacity-50 shadow-sm shadow-black/5"
