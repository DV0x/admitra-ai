...
export function VideoMessage({ message }: VideoMessageProps) {
  ...
  const handleDownload = (e: React.MouseEvent) => {
    ...
    // Use label for filename if available, otherwise default to admitra-video
      ...
      <div className="flex justify-start">
        <div className={aspectClasses[aspectRatio]}>
          <motion.div
            ...
            className="rounded-xl overflow-hidden shadow-sm shadow-black/5 border border-border cursor-pointer group"
